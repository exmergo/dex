...
new, update the referrers). That guard reads the same reference index
...
name the deleted node, and refusing on it would be unsatisfiable. The engine validates, diffs, and stores the plan
