...
recorded as `billed_seconds` in the ledger. Connections identify themselves with a `dex` user-agent for
attribution.

The estimate carries its DBU translation; the handshake itself is in
[`cost-controls.md`](cost-controls.md).
